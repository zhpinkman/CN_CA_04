...
def myNetwork():
    ...
    s2 = net.addHost('s2', cls=Host, ip='10.0.0.2',
                     mac='00:00:00:00:00:12', defaultRoute=None)  # email server
    s3 = net.addHost('s3', cls=Host, ip='10.0.0.3',
    ...
    s6 = net.addHost('s6', cls=Host, ip='10.0.1.2',
                     mac='00:00:00:00:00:22', defaultRoute=None)  # email server
    s7 = net.addHost('s7', cls=Host, ip='10.0.1.3',
    ...
    s10 = net.addHost('s10', cls=Host, ip='10.0.2.2',
                      mac='00:00:00:00:00:32', defaultRoute=None)  # email server
    s11 = net.addHost('s11', cls=Host, ip='10.0.2.3',
